...
class PulsarLayer(nn.Module):
    def __init__(
        ...
        # print(f"device tracker: {self.renderer.device_tracker}")
        self.renderer.device_tracker = torch.empty(size=(1,))
        self.my_device = device
        # print("In impCarv_points Pulsar's device:", self.my_device)
