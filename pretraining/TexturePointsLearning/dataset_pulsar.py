...
class PersonPulsar:
    ...
    def __init__(
        ...
        self.mesh_dir = join(
            root, "meshes"
        )  ## 50meshes:"50_meshes"; allMeshes:"meshes"; SingleMesh:"myMesh"
...
class PersonDatasetPulsar(Dataset):
    def __init__(self, person, sampling_points=300000, transform=None, latent_dim=3):
        self.person = person
    ...
    def __getitem__(self, idx):
        ...
        gamma_pts3d = input_mapping_torch(torch.from_numpy(pts_3d), self.device).type(
            torch.float64
        )
