...
class PersonPulsar(): 
    ...
    def __init__(self, person_id:int,  
        ...
        self.mesh_dir = join(root,"meshes")   ##50meshes: "50_meshes"; all meshes: "meshes"; SingleMesh: "myMesh"        
...
class PersonDatasetPulsar(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        latent_fpath = join(latent_dir, f"ep{epoch:06d}", 
                            f"latent_{pid}.pth")
        ...
        learnt_tex3d_dir = join(self.latent_path, 
                                f"TexturePoints_16Ch/learned_texPts")
        # my_epoch = 50 
        # learnt_tex3d_fpath = join(learnt_tex3d_dir, f"ep{my_epoch:06d}", "texture3d_313.pth")
        learnt_tex3d_fpath = join(learnt_tex3d_dir, f"ep{epoch:06d}", 
                                  f"texture3d_{pid}.pth")
        tex3d = torch.load(learnt_tex3d_fpath).squeeze(0)
        # print(f"latent:{latent_fpath}")
        # print(f"TextureLatent:{learnt_tex3d_fpath}")
